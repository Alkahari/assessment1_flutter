...
class _MyHomePageState extends State<MyHomePage> {
  String stockSymbol = "M";
  List<FlSpot> stockData = [];

  // Fungsi untuk mengambil data harga saham dari API
  Future<void> fetchData() async {
    final apiKey = "y4eutPe17D96PpfwkHimtUOUtLC6s24r";
    final response = await http.get(Uri.parse(
        'https://api.polygon.io/v2/aggs/ticker/M/range/1/day/2023-07-09/2023-08-09?adjusted=true&sort=asc&limit=120&apiKey=$apiKey'));
